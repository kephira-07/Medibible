...
export default function AppHeader({ right }) {
  return (
    <header className="flex w-full items-center justify-between rounded-full border border-[#dfeae7] bg-white/80 px-4 py-3 shadow-[0_10px_28px_rgba(24,54,66,0.06)] backdrop-blur-sm">
